...
#define SYSMENU_LABEL_MRUBY                (PAL_ADDITIONAL_WORD_FIRST + 6)
...
#define STATUS_LABEL_PUPPET                (PAL_ADDITIONAL_WORD_FIRST + 13)
#define STATUS_LABEL_BRAVE                 (PAL_ADDITIONAL_WORD_FIRST + 14)
#define STATUS_LABEL_PROTECT               (PAL_ADDITIONAL_WORD_FIRST + 15)
#define STATUS_LABEL_HASTE                 (PAL_ADDITIONAL_WORD_FIRST + 16)
#define STATUS_LABEL_DUALATK               (PAL_ADDITIONAL_WORD_FIRST + 17)
