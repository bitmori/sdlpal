...
static const char g_rgszAdditionalWords[][WORD_LENGTH + 1] = {
   ...
   {0xB0, 0xBD, 0xC5, 0xD1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // 偷竊	0xB0, 0xBD, 0xC5, 0xD1
   {0xA7, 0xF0, 0xC0, 0xBB, 0xAE, 0xC4, 0xAA, 0x47, 0x00, 0x00, 0x00}, // 攻擊效果	0xA7, 0xF0, 0xC0, 0xBB, 0xAE, 0xC4, 0xAA, 0x47
   {0xAD, 0xB7, 0xB9, 0x70, 0xA4, 0xF4, 0xA4, 0xF5, 0xA4, 0x67, 0x00}, // 風雷水火土0xAD, 0xB7, 0xB9, 0x70, 0xA4, 0xF4, 0xA4, 0xF5, 0xA4, 0x67
